<%-- 
    Document   : your_bookings
    Created on : 17 Aug, 2023, 1:03:01 PM
    Author     : Kunal Katira
--%>
...
<html>
    ...
    <body>
                <%String logv=request.getParameter("logv").toUpperCase();%>
            ...
            <a href="profile.jsp" class="user">
                ...
                <section class="asset_container">
                    ...
                    try {
                            ...
                            String q="Select * from booking where buyer_Id = '"+logv+"'";
//                            out.print(q);
                            String asid=null;
                            ...
                            String q2="Select * from asset_master where ass_id = '"+asid+"'";
                            ResultSet rs2 = st2.executeQuery(q2);

                            while (rs2.next()) {%>
                    <div class="asset_item">
                        <div class="asset_img"><img src="<%= rs2.getString(10)%>"></div>
                        <div class="asset_detail"> 
                            <p> <span><%out.print(rs2.getString(3).toUpperCase());%> </span></p>
                            <p><span><%out.print(rs2.getString(4).toUpperCase());%></span></p>
                            <p><span> <%out.print(rs2.getString(7).toUpperCase());%></span></p>
                        </div>
                        <div class="buttons">
                            <a class="btn btn-dark" href="self_assetview.jsp?asid=<%=rs2.getString(2)%>">View Asset</a>
                        </div>
                    </div>
                    <%   } }
                        } catch (Exception e) {
