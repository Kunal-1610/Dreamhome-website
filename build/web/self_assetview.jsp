<%-- 
    Document   : self_assetview
    Created on : 15 Aug, 2023, 5:00:30 PM
    Author     : Kunal Katira
--%>
...
//                                            out.println(id);
                    ResultSet rs = st.executeQuery("Select * from asset_master where ass_id=" + id );
                    while (rs.next()) {%>
           <div class="asset_item">
                <div class="item_img"> <%out.println("<img src=" + rs.getString(10) + ">");%></div>
                <div class="item_desc">
                    <div><span><i class='bx bx-rupee'></i><% out.println(rs.getString(9).toUpperCase());%></span></div>
